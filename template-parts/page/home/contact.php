...
$email_address = getCustomThemeValue("email_address", "hello@letswork.com.au");
...
?>
<div class="container lg:py-8 py-4" id="contact-section">
    <div class="row">
        <!-- Contact Details -->
        <div class="col-md-4 col-xs-12 col-md-4 col-xs-12 mb-4 md:mb-0">
            <h4 class="font-bold h4 mb-4 text-primary ">Office Address</h4>
            <!-- Contact Details -->
        ...
        <div class="col-md-8 col-xs-12">
            <?php echo do_shortcode("[HashtagContactForm form_id='contact-us' network_form='0' title='Contact Us' class='row']"); ?>
        </div>
